...
def build_rnn_search_model(source_vacabuary_size,
    ...
    for  encoder_rnn_output_dim in  encoder_rnn_output_dim_list:
        ...
        encoder_output = BiDirectionalLayer()([h1, h2], [source_word_mask, source_word_mask])
    ...
    rnn_decoder_output = rnn_decoder([decoder_input_sequence, source_context], [decoder_input_sequence_mask, None])
