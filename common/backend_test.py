...
class BackendTest(unittest.TestCase):
    ...
    def test_get_k_best_from_lattice(self):
        ...
        output, output_score = get_k_best_from_lattice(lattice, k=2, eos=-1)
        f = K.function(inputs=output_label_id_list + prev_output_index_list + output_score_list, outputs=[output, output_score])
        ...
        output_val, output_score_val = f(output_label_id_list_val + prev_output_index_list_val + output_score_list_val)
